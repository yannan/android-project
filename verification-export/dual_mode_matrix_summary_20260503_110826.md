...
- exportedAt: 2026-05-03 11:08:26
- totalRuns: 12
...
| --- | --- | --- | --- | --- | --- |
| tap | ACCESSIBILITY | false | local_direct | FAILED | tap(216,468), first=false, retry=true, mode=ACCESSIBILITY, hasWindow=true, activePkg=com.bbk.launcher2, gesture=completed |
| tap | SHIZUKU | false | local_direct | SUCCESS | tap(216,468), first=true, retry=false, mode=SHIZUKU |
| swipe | ACCESSIBILITY | false | local_direct | FAILED | swipe(540,1755->540,819), first=false, retry=true, mode=ACCESSIBILITY, hasWindow=true, activePkg=com.bbk.launcher2, gesture=completed |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-05-03 | vivo V1838A / Android 10 (SDK 29) / QP1A.190711.020 release-keys | `tap` | `ACCESSIBILITY` | `false` | FAILED | 待补充 | tap(216,468), first=false, retry=true, mode=ACCESSIBILITY, hasWindow=true, activePkg=com.bbk.launcher2, gesture=completed | 待补充 |
...
| 2026-05-03 | vivo V1838A / Android 10 (SDK 29) / QP1A.190711.020 release-keys | `swipe` | `ACCESSIBILITY` | `false` | FAILED | 待补充 | swipe(540,1755->540,819), first=false, retry=true, mode=ACCESSIBILITY, hasWindow=true, activePkg=com.bbk.launcher2, gesture=completed | 待补充 |
